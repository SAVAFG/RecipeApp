...
public class ProfileAdapter extends RecyclerView.Adapter<ProfileAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        for (User profile : users) {
            ...
            ids.add(profile.getName());
        }

        holder.myText2.setText(birthdays.get(position));
        holder.myText1.setText(ids.get(position));
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Calendar birthday = current.getBirthday();

            Toast.makeText(context, "The position is " + String.valueOf(position) +
                    " Id: " + id + ", Birthday:" + birthday.toString(), Toast.LENGTH_SHORT).show();
