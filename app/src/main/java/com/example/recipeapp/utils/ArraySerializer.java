...
public class ArraySerializer {
    ...
    public ArraySerializer(Context appContext) {
    ...
    public ArrayList<User> getListUsers(String key){
        ...
        for(String jObjString : objStrings){
            User value  = gson.fromJson(jObjString, User.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putUser(String key, User obj){
        checkForNullKey(key);
        Gson gson = new Gson();
        putString(key, gson.toJson(obj));
    }
    ...
    public void putListUser(String key, ArrayList<User> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<>();
        for(User obj : objArray){
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
