...
public class VitaminA implements Serializable {
     ...
     */
    public VitaminA(Boolean hasCompleteData, String name, Double amount, String percentDailyValue, String displayValue, String unit) {
        super();
    ...
    public String toString() {
        ...
        sb.append(VitaminA.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
