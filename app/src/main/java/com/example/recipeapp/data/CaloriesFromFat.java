...
public class CaloriesFromFat implements Serializable {
     ...
     */
    public CaloriesFromFat(Boolean hasCompleteData, String name, Double amount, String percentDailyValue, String displayValue, String unit) {
        super();
    ...
    public String toString() {
        ...
        sb.append(CaloriesFromFat.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
