...
public class Calories implements Serializable {
     ...
     */
    public Calories(Boolean hasCompleteData, String name, Double amount, String percentDailyValue, String displayValue, String unit) {
        super();
    ...
    public String toString() {
        ...
        sb.append(Calories.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
