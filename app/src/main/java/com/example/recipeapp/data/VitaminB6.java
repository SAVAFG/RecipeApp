...
public class VitaminB6 implements Serializable {
     ...
     */
    public VitaminB6(Boolean hasCompleteData, String name, Double amount, String percentDailyValue, String displayValue, String unit) {
        super();
    ...
    public String toString() {
        ...
        sb.append(VitaminB6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
